...
| [0020](0020-sdk-owns-build-execution.md) | The SDK owns build execution — the `alp` CLI is a thin surface over one engine (2-tier collapse); supersedes 0014's mechanism clause. Awaiting Hakan's co-sign | Proposed |
