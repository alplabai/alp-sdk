...
| [0020](0020-sdk-owns-build-execution.md) | One executor above the SDK: the SDK plans (Python), a single Rust executor beside the manager builds; `west alp-build` retired, SDK no longer standalone-buildable; supersedes 0014's mechanism clause + 84–87. Awaiting Hakan's co-sign | Proposed |
