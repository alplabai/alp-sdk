...
| [0020](0020-sdk-owns-build-execution.md) | The SDK plans; a standalone `tan` CLI (new repo, extracted from vscode) is the whole command surface + sole executor — three repos; `west alp-*` + `fan_out` + the `alp` script retired; supersedes 0014 mechanism + 84-87; pairs with #837. Awaiting Hakan's co-sign | Proposed |
