...
| [0020](0020-sdk-owns-build-execution.md) | The SDK owns build execution — a thin manager above the SDK (lifecycle + dispatch) forwards to one engine inside it (rustup/cargo split); supersedes 0014's mechanism clause. Awaiting Hakan's co-sign | Proposed |
