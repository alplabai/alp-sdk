...
| AEN801 peripheral matrix — RPi-style CSI-2 camera first light | `examples/aen/aen-camera-firstlight` (cam/csi/dphy + IMX219/OV5647/OV9281/IMX296 on the E1M-EVK J5) | 🟡 partial | Compiles + links against the real board target (four `build_only` twister scenarios); the CSI-2 -> CPI pipe has never run on real silicon | same | v0.8 |
