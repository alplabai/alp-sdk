...
| `validate_board_yaml.py` v0.3 capability cross-check | `scripts/validate_board_yaml.py` | 🟡 partial | Emits an `ALP-B010` warning (exit 0) on the deliberately-broken sample boards | `pr-metadata-validate.yml` | v0.3 |
