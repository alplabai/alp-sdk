...
```c
#include "alp_hw_info_build.h"    /* generated; defines ALP_HW_BUILD_SOM_SKU */
...
`alp_hw_info_build.h` is generated by `scripts/alp_project.py`
(`--emit hw-info-h`) from your `board.yaml`; the `ALP_HW_BUILD_*`
string macros in it are the single-source-of-truth for "what was
this firmware intended for?"
