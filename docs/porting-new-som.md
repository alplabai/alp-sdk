...
```json
{
  ...
  "npu_toolchain": {
    "vela": {
      ...
      "source": "examples/aen/aen-npu-inference-alp/CMakeLists.txt:42-43; examples/aen/aen-npu-inference-alp-u55/CMakeLists.txt:39-40"
    }
  },
  "soc_ram_kb": 13824,
  "soc_flash_mb": 5.5,
