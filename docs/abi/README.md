...
| [`v0.11-snapshot.json`](v0.11-snapshot.json)       | v0.11.0/v0.11.1 | —          | frozen                    |
| [`v0.12-snapshot.json`](v0.12-snapshot.json)       | v0.12.0         | —          | frozen                    |
| [`v0.13-snapshot.json`](v0.13-snapshot.json)       | v0.13.0         | tracks HEAD | **CURRENT** (regenerated by CI/`test-all.sh` until the next release) |
