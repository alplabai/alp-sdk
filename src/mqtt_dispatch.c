...
static void _free_mqtt(struct alp_mqtt *h) { h->in_use = false; }
...
alp_status_t alp_mqtt_publish(alp_mqtt_t *h, const char *topic,
...
alp_status_t alp_mqtt_subscribe(alp_mqtt_t *h, const char *topic_filter,
                                alp_mqtt_qos_t qos,
