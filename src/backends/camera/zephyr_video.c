...
static alp_status_t z_capture(alp_camera_backend_state_t *state,
                              ...
                              uint32_t timeout_ms)
{
    ...
    k_timeout_t t = (timeout_ms == UINT32_MAX)
                  ? K_FOREVER
                  : K_MSEC(timeout_ms);
...
static alp_status_t z_release(alp_camera_backend_state_t *state,
