...
struct alp_pwm_ops {
    ...
    alp_status_t (*set_duty)(alp_pwm_backend_state_t *state,
                             uint32_t pulse_ns);
    alp_status_t (*set_period)(alp_pwm_backend_state_t *state,
                               uint32_t period_ns);
    alp_status_t (*configure)(alp_pwm_backend_state_t *state,
                              alp_pwm_align_t align_mode,
                              uint32_t dead_time_ns,
                              uint8_t break_cfg);
    alp_status_t (*single_pulse)(alp_pwm_backend_state_t *state,
                                 uint32_t pulse_ns);
