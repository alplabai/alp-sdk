...
/*
 * The revision-dependent list (#2144) is NOT weak/board-provided: unlike
 * the two tables above, it is the SAME set on every AEN board regardless
 * of hw_rev or carrier, so it has exactly one definition --
 * src/backends/gpio/cc3501e_rev_dependent_pins.c, generated by
 * scripts/gen_cc3501e_gpio_routes.py and compiled unconditionally
 * alongside this file (zephyr/CMakeLists.txt) -- never overridden here.
 */
