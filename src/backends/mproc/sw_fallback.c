...
static alp_status_t sw_mbox_set_callback(alp_mbox_backend_state_t *state,
...
static alp_status_t sw_hwsem_open(uint32_t hwsem_id,
...
static alp_status_t sw_hwsem_lock(alp_hwsem_backend_state_t *state,
                                  uint32_t timeout_ms)
{
    (void)state;
    (void)timeout_ms;
