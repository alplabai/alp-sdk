...
static alp_status_t br_us_to_ticks(alp_counter_backend_state_t *st, uint32_t us, uint32_t *ticks_out) {
    (void)st; (void)us;
    *ticks_out = 0u;
    return ALP_ERR_NOSUPPORT;                          /* v0.3 adds CMD_COUNTER_GET_FREQ */
}

static alp_status_t br_set_alarm(alp_counter_backend_state_t *st,
