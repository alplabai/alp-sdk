...
static alp_status_t z_open(const alp_rpc_config_t *cfg,
...
static alp_status_t z_send(alp_rpc_backend_state_t *st, const char *method,
...
static alp_status_t z_call(alp_rpc_backend_state_t *st, const char *method,
