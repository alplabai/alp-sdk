...
static alp_status_t _errno_to_alp(int err) {
    ...
    case -ENOMEM:
    case -ENOSPC:     return ALP_ERR_NOMEM;
...
static alp_status_t lfs_open(const alp_storage_config_t *cfg,
    ...
    (void)snprintf(s->path, sizeof(s->path),
                   "/lfs%u/alp_storage.bin", (unsigned)cfg->instance_id);
...
static alp_status_t lfs_get_info(alp_storage_backend_state_t *st,
...
static alp_status_t lfs_read(alp_storage_backend_state_t *st,
...
static alp_status_t lfs_write(alp_storage_backend_state_t *st,
...
static alp_status_t lfs_erase(alp_storage_backend_state_t *st,
