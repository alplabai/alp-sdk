...
static void _free_shmem(struct alp_shmem *h) { h->in_use = false; }
...
static void _free_mbox(struct alp_mbox *h) { h->in_use = false; }
...
static void _free_hwsem(struct alp_hwsem *h) { h->in_use = false; }
