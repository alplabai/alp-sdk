...
static void _free_dev(struct alp_usb_dev *h) { h->in_use = false; }
...
static void _free_host(struct alp_usb_host *h) { h->in_use = false; }
...
alp_status_t alp_usb_device_write(alp_usb_dev_t *h, const uint8_t *data,
...
alp_status_t alp_usb_device_read(alp_usb_dev_t *h, uint8_t *data,
