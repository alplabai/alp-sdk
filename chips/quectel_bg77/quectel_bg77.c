...
alp_status_t quectel_bg77_power_on(quectel_bg77_t *dev)
{
	...
	/* 500 ms PWRKEY pulse per the Quectel BG77 HW design guide.  Sleep rather
	 * than busy-wait: alp_delay_us does not yield (include/alp/peripheral.h)
	 * and half a second of spinning starves every other thread on the core.
