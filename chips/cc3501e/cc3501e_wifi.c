                                   ...
                                   uint32_t    timeout_ms)
{
	 ...
	 *
	 * This closes the SECOND half of #1985.  cc3501e_wifi_connect() was
	 * converted to real-elapsed-time bounding first, by #1481; a comment on
	 * dev recorded that this loop still had the old accounting and called
	 * fixing it out of scope there.  It is in scope here, and both loops now
	 * bound themselves the same way.
	 */
