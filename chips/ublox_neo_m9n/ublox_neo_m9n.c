 ...
 *
 * u-blox NEO-M9N GNSS driver (UART NMEA line-reader).
 * See <alp/chips/ublox_neo_m9n.h>.
 */
...
alp_status_t ublox_neo_m9n_read_nmea_line(ublox_neo_m9n_t *dev, uint8_t *line_buf, size_t line_max,
