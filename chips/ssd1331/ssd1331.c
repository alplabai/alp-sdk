                          ...
                          size_t fb_len)
{
	...
	static const uint8_t init_seq[] = {
		CMD_DISPLAY_OFF,
		CMD_SET_REMAP,
		0x72, /* RGB colour, 65k mode 1, normal scan. */
		CMD_SET_DISPLAY_START,
		0x00,
		...
		CMD_SET_MUX_RATIO,
		0x3F, /* 64MUX. */
		CMD_SET_MASTER_CONFIG,
		0x8E, /* Select external Vcc (typical). */
		0xB0,
		0x0B, /* CMD_POWER_SAVE, disable. */
		CMD_SET_DCLK_DIV,
		0xF0,
		CMD_SET_PRECHARGE,
		0x32,
...
alp_status_t ssd1331_display(ssd1331_t *dev)
{
	...
	const uint8_t win_cmds[] = {
		CMD_SET_COLUMN_ADDR, 0x00, SSD1331_WIDTH - 1, CMD_SET_ROW_ADDR, 0x00, SSD1331_HEIGHT - 1,
	};
