 ...
 * (drivers/video/jpeg_hantro_vc9000e_regs.h) @
 * d8eed1926407087dff150a1c4d25ba586d775746 (branch main, repo
 * alifsemi/zephyr_alif).  ADR 0017 Tier-2 (INTERIM).  Register offsets/masks
 * for the VeriSilicon Hantro VC9000E JPEG encoder, consumed by
 * zephyr/drivers/video/jpeg_hantro_vc9000e.c (vendored + v4.4-ported).
 */
/*
