 ...
 * include/zephyr/drivers/video/isp_ctrl_params.h.  ADR 0017 Tier-2 (INTERIM).
 * Defines struct isp_params + ISP_PARAM_MASK_* that isp-vsi.h needs; pulled
 * in transitively via isp-vsi.h #include <zephyr/drivers/video/isp_ctrl_params.h>.
 */
/*
