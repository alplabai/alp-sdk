...
/* The EVK routes TWO TCAL9538 I/O expander positions, both on
 ...
 *     `evk_ioexp_pin_t`).  BENCH-CONFIRMED, 2 of 2 boards
 *     (alp-sdk#1974): strap A1=1, A0=1 -> 0x73 (silent at 0x72).
 ...
 *     ASSEMBLED on this EVK revision (alp-sdk#1974).
 *
