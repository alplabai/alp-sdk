...
ZTEST(alp_camera_registry, test_renesas_vendor_ext_returns_inval_on_null_handle)
{
    ...
    zassert_equal(
        alp_renesas_camera_isp_3a_window_set(NULL,
                                             ALP_RENESAS_CAMERA_3A_AE,
                                             &rect),
        ALP_ERR_INVAL);
    zassert_equal(
        alp_renesas_camera_isp_gain_table_load(NULL,
                                               ALP_RENESAS_CAMERA_CHANNEL_R,
                                               table, 16u),
        ALP_ERR_INVAL);
    zassert_equal(
        alp_renesas_camera_isp_lsc_lut_load(NULL, table, 64u),
        ALP_ERR_INVAL);
}
...
ZTEST(alp_camera_registry, test_alif_vendor_ext_returns_inval_on_null_handle)
{
    ...
    zassert_equal(
        alp_alif_camera_isp_3a_window_set(NULL,
                                          ALP_ALIF_CAMERA_3A_AE,
                                          &rect),
        ALP_ERR_INVAL);
    zassert_equal(
        alp_alif_camera_isp_gain_table_load(NULL,
                                            ALP_ALIF_CAMERA_CHANNEL_R,
                                            table, 16u),
        ALP_ERR_INVAL);
    zassert_equal(
        alp_alif_camera_isp_lsc_lut_load(NULL, table, 64u),
        ALP_ERR_INVAL);
}
...
ZTEST(alp_camera_registry, test_vendor_ext_null_rect_lut_table_rejected)
{
    ...
    zassert_equal(
        alp_renesas_camera_isp_3a_window_set(&fake,
                                             ALP_RENESAS_CAMERA_3A_AE,
                                             NULL),
        ALP_ERR_INVAL);
    zassert_equal(
        alp_renesas_camera_isp_gain_table_load(&fake,
                                               ALP_RENESAS_CAMERA_CHANNEL_R,
                                               NULL, 32u),
        ALP_ERR_INVAL);
    zassert_equal(
        alp_renesas_camera_isp_lsc_lut_load(&fake, NULL, 64u),
        ALP_ERR_INVAL);

    zassert_equal(
        alp_alif_camera_isp_3a_window_set(&fake,
                                          ALP_ALIF_CAMERA_3A_AE,
                                          NULL),
        ALP_ERR_INVAL);
    zassert_equal(
        alp_alif_camera_isp_gain_table_load(&fake,
                                            ALP_ALIF_CAMERA_CHANNEL_R,
                                            NULL, 32u),
        ALP_ERR_INVAL);
    zassert_equal(
        alp_alif_camera_isp_lsc_lut_load(&fake, NULL, 64u),
        ALP_ERR_INVAL);
}
...
ZTEST(alp_camera_registry, test_renesas_vendor_ext_rejects_non_renesas_backend)
{
    ...
    zassert_equal(
        ...
        ALP_ERR_NOT_PRESENT_ON_THIS_SOC);
    zassert_equal(
        alp_renesas_camera_isp_lsc_lut_load(&fake, table, 64u),
        ALP_ERR_NOT_PRESENT_ON_THIS_SOC);
}
...
ZTEST(alp_camera_registry, test_alif_vendor_ext_rejects_non_alif_backend)
{
    ...
    zassert_equal(
        ...
        ALP_ERR_NOT_PRESENT_ON_THIS_SOC);
    zassert_equal(
        alp_alif_camera_isp_lsc_lut_load(&fake, table, 64u),
        ALP_ERR_NOT_PRESENT_ON_THIS_SOC);
}
...
ZTEST(alp_camera_registry, test_renesas_vendor_ext_validates_input_ranges)
{
    ...
    zassert_equal(
        alp_renesas_camera_isp_gain_table_load(&fake,
                                               (alp_renesas_camera_channel_t)99,
                                               table, 16u),
        ALP_ERR_INVAL);
    ...
    zassert_equal(
        alp_renesas_camera_isp_lsc_lut_load(&fake, table, 32u),
        ALP_ERR_INVAL);
    zassert_equal(
        alp_renesas_camera_isp_lsc_lut_load(&fake, table, 8192u),
        ALP_ERR_INVAL);
...
ZTEST(alp_camera_registry, test_alif_vendor_ext_validates_input_ranges_then_nosupport)
{
    ...
    zassert_equal(
        ...
        ALP_ERR_INVAL);
    zassert_equal(
        alp_alif_camera_isp_lsc_lut_load(&fake, table, 32u),
        ALP_ERR_INVAL);
