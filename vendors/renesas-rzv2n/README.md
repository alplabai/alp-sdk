...
|--------------------|-------------------------------|-------------------------|-----------------|----------------------------|--------------------------|
| **E1M-X V2N**      | `E1M-V2N101`, `E1M-V2N102`    | `R9A09G056N44GBG#AC0`   | 32 / 64 Gbit    | eMMC 5.1, 32 / 64 Gbit     | —                        |
...
seen in the V2N101/V2N102 pair above: per the maintainer's ruling on #1230,
V2M101 is 8 GiB DRAM / 16 GiB eMMC and V2M102 is 8 GiB DRAM / 8 GiB eMMC --
V2M101 carries equal DRAM and MORE eMMC than V2M102. E1M-V2M101's values
are maintainer-confirmed (#1230); E1M-V2M102's are unverified. The
tier-naming inversion itself is unresolved and not tracked by any open
issue.
