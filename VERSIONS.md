...
| v0.8.0  | planned (2026-09-17) | V2M101 (DEEPX) silicon-verified + concurrent multi-NPU dispatch (DRP-AI3 + DEEPX simultaneously) proven on V2M101 + Mender OTA E2E.  Mender E2E demonstrated on V2N101 fleet of N≥3 boards (signed artefact + swap-using-scratch + rollback).  Ubuntu backend deferred to v2.0 phase (post-pilot) — H2-2026 stays Zephyr-on-M-cores + Yocto-on-A-cores. |
