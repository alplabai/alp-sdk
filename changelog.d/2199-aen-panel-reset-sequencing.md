...
`zephyr/boards/shields/e1m_evk_rk055hdmipi4ma0/e1m_evk_rk055hdmipi4ma0.overlay:156`
...
`examples/aen/aen-dsi-display/src/main.c:491`
...
before the panel regulator runs — `examples/aen/aen-dsi-display/src/main.c:233`
...
now `zephyr/drivers/mipi_dsi/dsi_dw.c:1136` ("value >> 8"). No in-tree caller
