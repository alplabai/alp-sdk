...
- `UTIMER_CNTR_CTRL` (`0x4800D080`) read `0x00000021` (EN and CNTR_TRIG set,
  RUNNING clear). `zephyr/drivers/sensor/qdec_alif/qdec_alif_utimer.c:349`
...
`examples/aen/aen-qenc-readout/src/main.c:99` (`0x49003050u`), and prints
the pad-control (mux + electrical) register values for both pins once at
start-up, `examples/aen/aen-qenc-readout/src/main.c:117`
...
`examples/aen/aen-qenc-readout/src/main.c:297`
