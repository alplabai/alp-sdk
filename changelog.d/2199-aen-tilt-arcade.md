...
full 1,843,200-byte redraw, and steering reads the carrier BMI323 (U13,
soldered on the E1M-EVK, not the SoM) over portable I2C
(`<alp/chips/bmi323.h>`, `<alp/peripheral.h>`), falling back to
