...
# The OS-topology + per-core OS-inference helpers now live in
# alp_orchestrate.topology (a #285 modularization seam); re-exported here so
# `from alp_orchestrate import emit_os_topology` (and the internal callers +
# tests) keep resolving unchanged.
from .topology import (  # noqa: E402,F401  (intentional re-export)
    CLASS_RUNTIMES,
