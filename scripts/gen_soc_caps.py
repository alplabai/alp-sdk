...
def _emit_cap_h() -> str:
    """Emit include/alp/cap.h — the portable public capability umbrella.

    This header wraps soc_caps.h (compile-time SoC constants) and
    cap_instance.h (run-time per-handle capability struct + helper).
    It is the single include point consumers of <alp/cap.h> need.

    Auto-generated by gen_soc_caps.py — DO NOT EDIT BY HAND.
    """
    lines: list[str] = [
        "/**",
        " * @file cap.h",
