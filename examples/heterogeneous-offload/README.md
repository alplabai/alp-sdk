...
```
examples/heterogeneous-offload/
...
```bash
west alp-build alp-sdk/examples/heterogeneous-offload
```
...
```bash
west alp-build alp-sdk/examples/heterogeneous-offload --core m33_sm
```
...
- [`examples/rpmsg-v2n/`](../rpmsg-v2n/) -- the simpler async event
