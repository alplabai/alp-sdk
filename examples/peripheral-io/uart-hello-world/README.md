...
Distinct from [`examples/peripheral-io/uart-echo`](../uart-echo/) -- that
...
west build -b native_sim/native/64 examples/peripheral-io/uart-hello-world \
    -- -DEXTRA_ZEPHYR_MODULES=$(pwd)
west build -t run

# On real silicon, point -b at the SoM's Zephyr board target.
# Example for E1M-AEN801:
west build -b alp_e1m_aen801_m55_hp/ae822fa0e5597ls0/rtss_hp examples/peripheral-io/uart-hello-world
west flash
```
...
- [`examples/peripheral-io/uart-echo/`](../uart-echo/) -- bidirectional companion.
- [`examples/peripheral-io/uart-rx-ringbuf/`](../uart-rx-ringbuf/) -- IRQ-driven RX into a ring buffer.
- [`docs/cross-platform-setup.md`](../../../docs/cross-platform-setup.md)
