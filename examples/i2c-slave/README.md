...
2. Flash a master example (modify `examples/i2c-master` to point
...
- [`examples/i2c-scanner/`](../i2c-scanner/) -- master-side discovery.
- [`examples/i2c-master/`](../i2c-master/) -- master-side known-address read.
