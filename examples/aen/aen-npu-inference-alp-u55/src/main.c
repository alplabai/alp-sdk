 ...
 * E1M-AEN801 (Ensemble E8) Ethos-U55 NPU *through the portable
 ...
 *
 * Model: person_detect_u85, Vela-compiled for ethos-u55-128 with the Alif
 * RTSS_HE_SRAM_Only system-config (see CMakeLists.txt / gen_model.py).  ~263
...
int main(void)
{
	printk("\n=== aen-npu-inference-alp (alp_inference_open -> Ethos-U55) ===\n");
