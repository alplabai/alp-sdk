...
[evkdemo] SD: fs_mount -> -ENODEV -- subsys/fs/fat_fs.c maps three FatFs causes onto the same code: either no FAT filesystem on this card, or a mount-point/FF_VOLUME_STRS mismatch (disk name already cleared by disk_access_init returning 0): ...
```
