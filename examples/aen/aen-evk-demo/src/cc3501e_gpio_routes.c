 ...
 *
 * CC3501E GPIO-proxy route table for aen-evk-demo -- the ONE proxied pad this
 * app drives, and no more.
 *
 ...
 * pad phase 9 actually drives. That entry is still pinned to metadata rather
 * than trusted -- tests/scripts/test_aen_cc3501e_routes.py checks it against
 * metadata/e1m_modules/aen/from-cc3501e.tsv, the same source the generator
 * resolves through, and asserts it stays a SUBSET of the full map. Add a pad
 * here only alongside that test.
 *
