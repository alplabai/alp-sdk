 ...
 * drive the SDIO mux ENABLE (E1M IO20 -> CC3501E GPIO_26) before touching
 * sdhc0, on the physically reworked e1m-aen-evk-03 bench board. See the
 * board overlay and src/main.c for the full rationale; this file itself is
