...
| Directory                                          | What it shows                                                                |
|----------------------------------------------------|------------------------------------------------------------------------------|
| [`aen-camera-firstlight`](aen-camera-firstlight/)  | **bench** -- Raspberry-Pi-style CSI-2 camera first light (IMX219 / OV5647 / OV9281 / IMX296 on the E1M-EVK's J5) through the portable `<alp/camera.h>` API; OV9281 bench-verified on an E1M-AEN803 on the E1M-EVK (2026-09-21, all three modes); OV5647 bench-attempted, BLOCKED at D-PHY Stop-state (issue #2248); IMX219/IMX296 not yet run on silicon this batch (no module seated). |
