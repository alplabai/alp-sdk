...
| [`aen-sdcard-readout`](aen-sdcard-readout/)        | Register-level bring-up probes for the E8 SD Host Controller (`snps,dwc-sdhc`) -- **on the E1M-EVK 2626-R2, `sdhc0` stays disabled and the probes compile out to a SKIPPED message** (#2051, SD mux hardware defect); see the example's own README. |
