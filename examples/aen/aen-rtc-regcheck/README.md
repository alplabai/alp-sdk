...
| Kconfig | `COUNTER_RTC_SNPS_DW`, `depends on DT_HAS_SNPS_DW_APB_RTC_ENABLED` | fork `drivers/counter/Kconfig.dw_rtc`; mirrored in `zephyr/Kconfig` |
...
west build -p always -b alp_e1m_aen801_m55_he/ae822fa0e5597ls0/rtss_he \
    ...
    -DEXTRA_DTC_OVERLAY_FILE=examples/aen/aen-rtc-regcheck/boards/alp_e1m_aen801_m55_he.overlay
```
