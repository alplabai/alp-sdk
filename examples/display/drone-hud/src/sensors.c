 ...
 *   2. Run a 100 Hz IMU sample + attitude loop.  Attitude comes
 *      from the `<alp/ahrs.h>` Madgwick filter, which fuses gyro
 *      and accelerometer into a quaternion; the app never
 *      hand-rolls fusion.
