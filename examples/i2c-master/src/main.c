 ...
 * examples/i2c-scanner which probes every 7-bit address for ACKs
 ...
 * On a brand-new bring-up you may want to run examples/i2c-scanner
...
int main(void) {
    printf("[i2c-master] open E1M_I2C0 @ 400 kHz\n");
